...
Rauthy provied the Admin and User GUI and Server and replication, with OIDC. 

For https://github.com/sebadob/rauthy/issues/1582

Once this is done we can combine Auth and ReBac using Cedar ( https://github.com/cedar-policy/cedar9 , allowing a clean and extensible security system with minimal resource usage. Cedar runs fine on Cloudflare. Rauthy client has the required primitives for this.
